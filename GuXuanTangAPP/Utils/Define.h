...
#define kMianColor          kHexColor(0xc4181c)
#define kBgColor            kHexColor(0xF5F5F5)
...
#define kSeperatorColor     kHexColor(0xe5e5e5)

#define Stock_BG                    kHexColor(0xF5F5F5)
#define Stock_TitleColor            kHexColor(0x333333)
#define Stock_SubTitleColor         kHexColor(0x888888)
#define Stock_GreenColor            kHexColor(0x23912e)
#define Stock_RedColor              kHexColor(0xc4181c)
